        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(role2.equals("Administrator")){
                    ...
                    Intent passdata = new Intent(Home.this, SP_profile.class);
                    passdata.putExtra("Name",username);
                    startActivity(passdata);

                    Intent passdata2 = new Intent(Home.this, AvailableTime.class);
                    passdata.putExtra("Name2",username);
